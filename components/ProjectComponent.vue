<template>
    <NuxtLink :to="'projects/' + project.slug.current" class="flex-col m-4 fadeIn">
        <div
            class="flex transition-all duration-300 transform hover:scale-[0.99] aspect-square lg:aspect-[5/4] w-full h-[329px] lg:h-auto lg:h-[600px] bg-cover bg-center rounded-3xl relative border border-gray-900"
