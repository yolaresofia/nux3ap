  ...
  <footer :class="[returnThemeClassFooter(true), 'w-full pb-4 px-2 md:px-4']">
    <div class="flex justify-between w-full">
      <div class="flex flex-col-reverse md:flex-row justify-between md:w-full">
        <img
          :class="[mainTheme === 'black' && 'invert', 'w-24 md:w-60']"
          :src="settings.circleLogo"
        />
        <div class="flex items-end" @click="moveTo()">
          <img
            class="md:w-28 w-24 pr-4 cursor-pointer"
      ...
      <div class="flex mt-auto">
        <div class="flex flex-col space-y-3 items-end">
          <img
            :src="settings.logo"
            :class="[mainTheme === 'black' && 'invert', 'h-auto w-28 md:w-44']"
          />
    ...
    <div
      class="flex w-full flex-col text-right md:flex-row md:justify-between text-xs py-3"
    >
