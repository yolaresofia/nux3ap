<template>
    ...
    >
        ...
        <div class="mt-2 ml-auto">
            <button @click="openModal" class="px-2 py-1 helvetica-heavy mx-1 text-black bg-white rounded-3xl">Learn more</button>

            <button @click="closeBanner" class="px-2 py-1 helvetica-heavy mx-1 text-white bg-black rounded-3xl">Agree & close</button>
        </div>
    </div>
</template>
