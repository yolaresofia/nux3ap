<template>
    <div :class="[isCentered && isMobile ? 'h-screen' : '']">
            ...
            <div v-if="src?.indexOf('jpg') === -1" class="relative w-full h-full">
                ...
                <div v-if="!hidePause" :class="[isCentered ? 'fixed-center' : 'center', 'group']">
                    <button :class="['z-50', isRotated ? 'rotate-90' : 'rotate-0']" @click="play">
                        <svg id="Layer_1" fill="white" xmlns="http://www.w3.org/2000/svg" class="w-20 lg:w-40"
                            viewBox="0 0 200 200">
                            <g id="Group_102">
                                <g class="opacity-0 group-hover:opacity-100">
                                    <rect fill="white" v-show="!paused && !isMobile" id="Rectangle_104" class="cls-1"
                                        x="65.31" y="56.04" width="32" height="91" rx="2" ry="2" />
                                    <rect fill="white" v-show="!paused && !isMobile" id="Rectangle_105" class="cls-1"
                                        x="105.31" y="56.04" width="32" height="91" rx="3" ry="3" />
                                </g>
                                <path class="" v-show="paused"
                ...
                <!-- full screen⁄ -->
                <div v-if="!isMobile" class="absolute z-50 w-5 lg:w-20 lg:bottom-[30px] bottom-4 right-4 cursor-pointer"
                    @click="toggleFullScreen">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 50">
                        <g id="Group_108" data-name="Group 108" transform="translate(-1095 -799)">
                            <rect id="Rectangle_188" data-name="Rectangle 188" width="16" height="50"
                                transform="translate(1095 799)" fill="#fff" />
                            <rect id="Rectangle_189" data-name="Rectangle 189" width="16" height="50"
                                transform="translate(1159 799)" fill="#fff" />
                            <rect id="Rectangle_190" data-name="Rectangle 190" width="16" height="32"
                                transform="translate(1127 799) rotate(90)" fill="#fff" />
                            <rect id="Rectangle_193" data-name="Rectangle 193" width="16" height="32"
                                transform="translate(1127 833) rotate(90)" fill="#fff" />
                            <rect id="Rectangle_191" data-name="Rectangle 191" width="16" height="32"
                                transform="translate(1175 799) rotate(90)" fill="#fff" />
                            <rect id="Rectangle_192" data-name="Rectangle 192" width="16" height="32"
                                transform="translate(1175 833) rotate(90)" fill="#fff" />
                        </g>
                    </svg>
                </div>
                <!-- rotate -->
                <div v-if="isMobile && !isRotated && isCentered"
                    class="absolute z-50 w-[3.4rem] lg:w-40 top-[85px] lg:right-[3px] right-[15px]" @click="rotate">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45.92 58.29">
                        <g>
                            <path class="st0 fill-white" d="M21.21,40.88l3.44,1.43c0.14,0.06,0.11,0.27-0.05,0.28c-4.59,0.39-9.28-1.51-12.26-5.46
		...
		c-0.07-0.03-0.16,0-0.19,0.08l-2.43,5.84C21.1,40.76,21.13,40.85,21.21,40.88z" />
                            <path class="st0 fill-white" d="M38.86,17.17c-3.29-4.37-8.08-7.19-13.49-7.95c-2.25-0.32-4.5-0.26-6.67,0.15c-0.11,0.02-0.21-0.09-0.16-0.2
		...
		l5.99,2.04c0.08,0.03,0.16-0.02,0.19-0.09C44.05,29.56,42.9,22.55,38.86,17.17z" />
                        ...
                        <g id="Path_55" transform="translate(38.651 53.118) rotate(180)">
                            <path id="Path_55-2" class="st0 fill-white"
                                d="M-29.24,50.97l-26.87-26.56l26.87-26.56l11.78,11.64l-15.09,14.92l15.09,14.92L-29.24,50.97z" />
                        </g>
                    </svg>
                </div>
                <!-- close -->
                <div v-if="isCentered"
                    :class="[isRotated ? 'fixed bottom-[15px] -right-[10px]' : '-top-4 -right-[20px] absolute', ' z-[180] w-30 lg:w-40 lg:right-[3px] ']"
                    @click="close">
                ...
                <!-- <iframe v-if="isVimeo" :src="src" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe> -->
                <!-- <iframe v-if="isVimeo" :src="src" width="640" height="268" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe> -->
                        ...
                        : isRotated && isCentered && !isMobile
                            ...
                            : !isRotated && isCentered && isMobile
                                ...
                                : isRotated && isCentered && isMobile
                                    ? 'rotate'
                                    : 'fixedVideo',
                ]" ref="video" playsinline :src="src" loop autoplay @click="pause" @canplay="updatePaused"
                    @playing="updatePaused" @pause="updatePaused"
                    :type="src.includes('mp4') ? 'video/mp4' : 'video/webm'"></video>
                <div v-show="isRotated && isMobile && isCentered && paused"
                    class="w-full rotate-bar h-2 bg-gray-200 rounded-full opacity-60">
